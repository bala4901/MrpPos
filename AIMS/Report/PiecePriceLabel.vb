...
Public Class PiecePriceLabel
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AIMS.PiecePriceLabel.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPiecePriceLabel
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PiecePriceLabel = New PiecePriceLabel()
        rpt.Site = Me.Site
        Return rpt
    End Function
