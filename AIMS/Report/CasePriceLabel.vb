...
Public Class CasePriceLabel
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AIMS.CasePriceLabel.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCasePriceLabel
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CasePriceLabel = New CasePriceLabel()
        rpt.Site = Me.Site
        Return rpt
    End Function
