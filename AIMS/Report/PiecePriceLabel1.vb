...
Public Class PiecePriceLabel1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AIMS.PiecePriceLabel1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPiecePriceLabel1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PiecePriceLabel1 = New PiecePriceLabel1()
        rpt.Site = Me.Site
        Return rpt
    End Function
