...
Public Class PieceSummaryLabel
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AIMS.PieceSummaryLabel.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPieceSummaryLabel
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PieceSummaryLabel = New PieceSummaryLabel()
        rpt.Site = Me.Site
        Return rpt
    End Function
