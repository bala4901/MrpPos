...
''' <summary>
'''Entity Class for table Mrp_order_line_box
''' </summary>
''' <remarks>
'''Write your custom method and property here
''' </remarks>

Public Class Mrp_order_line_box
	Inherits _Mrp_order_line_box
...
''' </remarks>
Public Class Mrp_order_line_boxDAO
	Inherits _Mrp_order_line_boxDAO
