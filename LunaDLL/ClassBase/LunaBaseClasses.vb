...
End Sub
	Protected Shared Function OpenConn(ConnString As String) As Integer
		...
		Try
			If DbConnection Is Nothing Then DbConnection = New OleDBConnection
		...
		Catch ex As Exception
			Ris = 1
			throw new ApplicationException("Error Opening DB", ex)
		End Try
		Return Ris
	End Function
    Public Shared Property DisableLazyLoading As Boolean = false
End Class

Public MustInherit Class LunaBaseClass

Public Sub ManageError(ByVal ex As Exception)
	throw new ApplicationException("ManageError", ex)
End Sub
...
Protected _cn As  OleDBConnection
...
Public Sub New()
	...
	'By default use OPENDBCONNECTION method of LUNACONTEXT Object
	LUNA.LunaContext.OpenDbConnection()
	_cn = DbConnection
End Sub
...
Public Sub New(ByVal ConnectionString As string)
	'Create a New Connection adHoc and close it at dispose of class
...
Dim Ris As Integer = 0
Try
	If _cn Is Nothing Then _cn = New OleDBConnection
